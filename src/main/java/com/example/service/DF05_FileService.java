...
//        return fileRepository.getOriginNameByFileNameAndPath(fileName, path);
//    }
    ...
    // db와 절대경로 두 군데서 삭제
    public void absolute_delete_file(String fileName, String path, int fno) {
        // 파일 경로 생성
    ...
    public int updateStatusFile(int fno) {
        return fileRepository.updateStatusFile(fno);
    }

    public DF05_FileDTO findByFno(int fno) {
        return fileRepository.findByFno(fno);
    }
