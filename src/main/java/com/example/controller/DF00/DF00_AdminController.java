...
//        fileDTO.setYn(yn);
    ...
    @GetMapping("/fileManagement/deleteBoth")
    public String adminFileDelete(@RequestParam("file_name") String file_name
                                  ,@RequestParam("path") String path
                                  ,@RequestParam("fno") int fno) {
        fileService.absolute_delete_file(file_name, path, fno);
        return "redirect:/admin/fileManagement";
    }
