...
//        model.addAttribute("isAdmin", SecurityContextHolder.getContext().getAuthentication().getAuthorities().contains("ROLE_ADMIN"));
//        return "login";
//    }
//
//    @PostMapping("/login")
//    @Validated
//    public String loginSubmit(DF01_MemberDTO memberDTO, BindingResult bindingResult) {
//        if (bindingResult.hasErrors()) {
//            return "login";
//        }
//
//        Authentication authentication = authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(memberDTO.getId(), memberDTO.getPassword()));
