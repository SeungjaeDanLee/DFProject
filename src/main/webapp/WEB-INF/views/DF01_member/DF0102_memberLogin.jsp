...
<head>
    ...
    <script src="../resources/js/DF01_member/DF0102_login.js"></script>
...
<div class="login">
    <form class="login_form" action="/members/login" method="post">
        ...
        <input type="text" id="id" name="id" oninput="characterCheck(this)" required="">

        <label for="password">비밀번호</label>
        <input type="password" id="password" name="password" oninput="characterCheck(this)" required="">
