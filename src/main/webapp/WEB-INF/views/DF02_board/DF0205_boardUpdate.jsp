...
<%--            <c:forEach items="${fileList}" var="file">--%>
                <ul>
                    <li>
                        <input id="file" type="file" name="file" value="${file.origin_name}">
                            ${file.origin_name}
                    </li>
                </ul>
<%--            </c:forEach>--%>
            <%--                    <a style="display: flex; justify-content: right; align-items: center;"--%>
            <%--                       href="/file/download?file_name=${file.file_name}&path=${file.path}">--%>
            <%--                        다운로드--%>
            <%--                    </a>--%>
            <ul>
