...
const updateStatusFile = (fno, yn) => {
    location.href = "/admin/fileManagement/update?fno=" + fno + "&yn=" + yn;
};
...
// const deleteFile = (fno, path) => {
//     location.href = "/admin/fileManagement/delete?fno=" + fno + "&path=" + path;
// }