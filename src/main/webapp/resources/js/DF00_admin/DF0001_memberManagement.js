...
const updateMember = (mno, member_level) => {
    console.log("member_level" + member_level);
    location.href = "/admin/memberManagement/update?mno=" + mno + "&member_level=" + member_level;
};

const deleteMember = (mno) => {
    location.href = "/admin/memberManagement/delete?mno=" + mno;
}
